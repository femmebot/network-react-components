...
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {computed, decorate, extendObservable} from 'mobx';
&nbsp;
/**
...
export function assignComputed&lt;T = any&gt;(
  ...
  let value;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (key in obj) {
...
&nbsp;
  if (setter) {
    extendObservable(obj, {
      ...
      set [key](val) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (setter) {
          setter(val);
        }
      },
    });
...
&nbsp;
<span class="fstat-no" title="function not covered" >export function error(<span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" >...args</span>)</span> {</span>
  // tslint:disable-next-line:no-console
<span class="cstat-no" title="statement not covered" >  console.error(`[datx error]`, ...args);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >export function warn(<span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" >...args</span>)</span> {</span>
<span class="cstat-no" title="statement not covered" >  if (process.env.NODE_ENV === 'production' || process.env.NODE_ENV === 'test') {</span>
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
  // tslint:disable-next-line:no-console
<span class="cstat-no" title="statement not covered" >  console.warn(`[datx warning]`, ...args);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >export function deprecated(<span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" >...args</span>)</span> {</span>
<span class="cstat-no" title="statement not covered" >  if (process.env.NODE_ENV === 'production' || process.env.NODE_ENV === 'test') {</span>
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
  // tslint:disable-next-line:no-console
<span class="cstat-no" title="statement not covered" >  console.warn(`[datx deprecated]`, ...args);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >export function info(<span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" >...args</span>)</span> {</span>
<span class="cstat-no" title="statement not covered" >  if (process.env.NODE_ENV === 'production' || process.env.NODE_ENV === 'test') {</span>
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
  // tslint:disable-next-line:no-console
<span class="cstat-no" title="statement not covered" >  console.info(`[datx info]`, ...args);</span>
}
&nbsp;</pre></td></tr>
</table></pre>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu Sep 06 2018 18:40:41 GMT+0200 (CEST)
</div>
</div>
