...
import {PaymentMethodId} from '~data'

export class CreatePaymentMethod extends jsonapi(Model) {
  public static type = 'payment_methods'

  @prop.identifier public id: PaymentMethodId

  @prop public stripe_card_token: string

  @prop public organization_id: number
